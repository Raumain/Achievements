...
export const Route = createFileRoute("/_auth/settings/dashboard/$id")({
	component: () => <Dashboard />,
});
...
const Dashboard = () => {
	...
	const achievement = useQuery(api.achievements.getById, {
		id: id as Id<"achievements">,
	});
	const updateAchievement = useMutation(api.achievements.update);
	const deleteAchievement = useMutation(api.achievements.deleteById);

	const handleUpdate = ({
		id,
		updatedData,
	}: { id: Id<"achievements">; updatedData: AchievementUpdate }) => {
